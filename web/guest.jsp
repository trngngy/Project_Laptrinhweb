        ...
        <div class="container">
            <div class="row">
                <div class="display-header d-flex justify-content-between pb-3">
                    ...
                    <div class="btn-right">
                        <a href="login.jsp" class="btn btn-medium btn-normal text-uppercase">Go to Shop</a>
                    </div>
                </div>
                    ...
                    <div class="swiper-wrapper">
                            ...
                            <div class="product-card position-relative">
                                ...
                                <div class="card-detail d-flex justify-content-between align-items-baseline pt-3">
                                    <h3 class="card-title text-uppercase">
                                        <a href="login.jsp">Apple Watch Series 5</a>
                                    </h3>
                        ...
                        <div class="swiper-slide">
                            <div class="product-card position-relative">
                                ...
                                <div class="card-detail d-flex justify-content-between align-items-baseline pt-3">
                                    <h3 class="card-title text-uppercase">
                                        <a href="login.jsp">Apple Watch Series 8</a>
                                    </h3>
                        ...
                        <div class="swiper-slide">
                            <div class="product-card position-relative">
                                ...
                                <div class="card-detail d-flex justify-content-between align-items-baseline pt-3">
                                    <h3 class="card-title text-uppercase">
                                        <a href="login.jsp">Apple Watch Series 3</a>
                                    </h3>
                        ...
                        <div class="swiper-slide">
                            <div class="product-card position-relative">
                                ...
                                <div class="card-detail d-flex justify-content-between align-items-baseline pt-3">
                                    <h3 class="card-title text-uppercase">
                                        <a href="login.jsp">Apple Watch 4 LTE</a>
                                    </h3>
                        ...
                        <div class="swiper-slide">
                            <div class="product-card position-relative">
                                ...
                                <div class="card-detail d-flex justify-content-between pt-3">
                                    <h3 class="card-title text-uppercase">
                                        <a href="login.jsp">Apple Watch Series 6</a>
                                    </h3>
                                    <span class="item-price text-primary">$750.0</span>
                                </div>
                            </div>
