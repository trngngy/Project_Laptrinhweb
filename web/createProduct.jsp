<%-- 
    ...
    Created on : Jun 28, 2024, 1:06:34 AM
    Author     : nguye
--%>
            ...
            <form action="MainController" method="POST" enctype="multipart/form-data">
                <div class="row">
                        ...
                        <div class="p-3 p-lg-5 border">
                            <div class="form-group row">
                                <div class="col-md-12">
                                    ...
                                    <span class="text-danger"><%= ProductError.getProductID()%></span></br>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <label for="name" class="text-black">Model <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="name" name="Model">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-12">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <label for="description" class="text-black">Color </label>
                                    <input type="text" class="form-control" id="description" name="Color">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-5 ml-auto">
                        <div class="form-group row">
                            <div class="col-md-12">
                                <label for="ImageURL" class="text-black">Image</label>
                                <input type="file" class="form-control" id="image" name="ImageURL" onchange="previewImage(event)">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-12">
